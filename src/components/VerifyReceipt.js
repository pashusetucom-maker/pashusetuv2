      ...
      <div className="container">
        ...
        <div className="compact-receipt">
          ...
          <div className="compact-single-column">
            ...
            {receipt.sellerKhasra && (
              <div className="compact-item">
                <span className="compact-label">Khasra / खसरा:</span>
                <span className="compact-value">{receipt.sellerKhasra}</span>
              </div>
            )}
            ...
            {receipt.buyerKhasra && (
              <div className="compact-item">
                <span className="compact-label">Khasra / खसरा:</span>
                <span className="compact-value">{receipt.buyerKhasra}</span>
              </div>
            )}
        ...
        {(receipt.sellerSignatureUrl || receipt.buyerSignatureUrl || receipt.registrarSignatureUrl || 
          ...
          receipt.animalPhotoUrl || receipt.certificatePhotoUrl || receipt.sellerKhasraPhotoUrl || receipt.buyerKhasraPhotoUrl ||
          ...
          <div className="card no-print" style={{ marginTop: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '15px', marginBottom: '25px' }}>
              ...
              {receipt.sellerKhasraPhotoUrl && (
                ...
                onClick={() => {
                  setFullscreenImage(typeof receipt.sellerKhasraPhotoUrl === 'string' ? receipt.sellerKhasraPhotoUrl : receipt.sellerKhasraPhotoUrl?.url || '');
                  setFullscreenImageAlt('Seller Khasra/B-1/KCC');
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'scale(1.02)';
                  e.currentTarget.style.boxShadow = '0 4px 12px rgba(0, 0, 0, 0.15)';
                ...
                >
                  ...
                  <img 
                    src={typeof receipt.sellerKhasraPhotoUrl === 'string' ? receipt.sellerKhasraPhotoUrl : receipt.sellerKhasraPhotoUrl?.url || ''} 
                    alt="Seller Khasra/B-1/KCC" 
                    crossOrigin="anonymous"
                    onError={(e) => {
                      console.error('Failed to load Seller Khasra photo');
                      e.target.style.display = 'none';
                      e.target.nextSibling.style.display = 'block';
                    }}
                    style={{ 
              ...
              {receipt.buyerKhasraPhotoUrl && (
                ...
                onClick={() => {
                  setFullscreenImage(typeof receipt.buyerKhasraPhotoUrl === 'string' ? receipt.buyerKhasraPhotoUrl : receipt.buyerKhasraPhotoUrl?.url || '');
                  setFullscreenImageAlt('Buyer Khasra/B-1/KCC');
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'scale(1.02)';
                  e.currentTarget.style.boxShadow = '0 4px 12px rgba(0, 0, 0, 0.15)';
                ...
                >
                  ...
                  <img 
                    src={typeof receipt.buyerKhasraPhotoUrl === 'string' ? receipt.buyerKhasraPhotoUrl : receipt.buyerKhasraPhotoUrl?.url || ''} 
                    alt="Buyer Khasra/B-1/KCC" 
                    crossOrigin="anonymous"
                    onError={(e) => {
                      console.error('Failed to load Buyer Khasra photo');
                      e.target.style.display = 'none';
                      e.target.nextSibling.style.display = 'block';
                    }}
                    style={{ 
