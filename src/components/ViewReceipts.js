  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(receipt =>
        ...
        (receipt.sellerKhasra || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
        (receipt.buyerKhasra || '').toLowerCase().includes(searchTerm.toLowerCase())
      );
    }
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '12px' }}>
            <div style={{ position: 'relative' }}>
              ...
              <input
                type="text"
                placeholder="Search ID, Name, Mobile, Aadhaar, Village, Khasra, Vehicle..."
                value={searchTerm}
                ...
                <tbody>
                  {filteredReceipts.map(receipt => (
                    <tr key={receipt.id}>
                      ...
                      <td>{receipt.sellerKhasra || '-'}</td>
                      <td>{receipt.buyerKhasra || '-'}</td>
